                 ...
                 <form action="{{ route('login') }}" method="POST" class="space-y-6"> @csrf <div class="space-y-4">
                         ...
                         <div class="flex items-center justify-between">
                             <div class="flex items-center"> <input id="remember" name="remember" type="checkbox"
                                     class="h-4 w-4 text-#8A2BE2 focus:ring-#8A2BE2 border-gray-300 rounded"> <label
                                     for="remember" class="ml-2 block text-sm text-gray-700">Se souvenir de moi</label>
                             </div> <a href="{{ route('password.request') }}" class="text-sm font-medium text-#8A2BE2 hover:text-#8A2BE2/80">Mot de
                                 passe oublié ?</a>
                         </div>
                     </div> <button type="submit"
                         class="w-full bg-violet-600 hover:bg-#8A2BE2/90 text-white font-bold py-3 px-6 !rounded-button shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                         Se connecter </button>
                     ...
                     <div class="text-center mt-8">
                         <p class="text-gray-600">Pas encore membre ? <a href="{{ route('signup') }}"
                                 class="text-#8A2BE2 font-medium hover:underline">Inscrivez-vous</a></p>
                     </div>
                 </form>
             </div>
         </div>
