<!DOCTYPE html>
 ...
 <body class="bg-[#f9f9ff]">
     <div class="min-h-screen flex flex-col md:flex-row">
         <div
             class="md:w-2/5 bg-gradient-to-br from-#8A2BE2/90 to-[#4B0082]/90 relative overflow-hidden flex items-center justify-center p-6 md:p-0">
                             ...
                             <div class="space-y-2">
                                 ...
                                 <div class="file-input-container">
                                     <div
                                         ...
                                         <div
                                             class="w-12 h-12 mx-auto flex items-center justify-center bg-[#8A2BE2]/10 rounded-full mb-2">
                                             <i class="ri-user-add-line text-[#8A2BE2] text-xl"></i>
                                         </div>
                             ...
                             <div class="space-y-2">
                                 ...
                                 <div class="file-input-container">
                                     <div
                                         ...
                                         <div
                                             class="w-12 h-12 mx-auto flex items-center justify-center bg-[#8A2BE2]/10 rounded-full mb-2">
                                             <i class="ri-image-add-line text-[#8A2BE2] text-xl"></i>
                                         </div>
                                         <p class="text-sm text-gray-600">Cliquez pour sélectionner une image</p>
                                         <p class="text-xs text-gray-500 mt-1">JPG, PNG ou GIF (max. 2MB)</p>
                     ...
                     <div class="flex items-start mt-6">
                         <div class="flex items-center h-5">
                             <input id="terms" name="terms" type="checkbox"
                                 class="h-4 w-4 text-[#8A2BE2] focus:ring-[#8A2BE2] border-gray-300 rounded" required>
                         </div>
                         <div class="ml-3 text-sm">
                             <label for="terms" class="font-medium text-gray-700">J'accepte les <a href="#"
                                     class="text-[#8A2BE2] hover:underline">conditions d'utilisation</a> et la <a href="#"
                                     class="text-[#8A2BE2] hover:underline">politique de confidentialité</a></label>
                         </div>
                     </div>
                     <div class="flex justify-center">
                         <button type="submit"
                             class="w-full md:w-1/2 bg-violet-600 hover:bg-[#8A2BE2]/90 text-white font-bold py-3 px-6 !rounded-button shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 whitespace-nowrap">
                             S'inscrire
                         </button>
                     </div>
                     <div class="text-center mt-6">
                         <p class="text-gray-600">Déjà membre ? <a href="{{ route('login') }}"
                                 class="text-[#8A2BE2] font-medium hover:underline">Connectez-vous</a></p>
                     </div>
                 </form>
             </div>
         </div>
